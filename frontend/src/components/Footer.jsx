...
const Footer = () => (
  <div style={{ background:"#090D1A", borderTop:"1px solid rgba(255,255,255,0.06)", fontFamily:"'DM Sans','Inter',sans-serif" }}>
    <style>{`
      .footer-inner { padding: 28px 44px; }
      .footer-top { display:flex; justify-content:space-between; align-items:center; margin-bottom:20px; flex-wrap:wrap; gap:16px; }
      .footer-links { display:flex; gap:26px; flex-wrap:wrap; }
      .footer-copy { border-top:1px solid rgba(255,255,255,0.05); padding-top:16px; font-size:13px; color:#2A3F60; }
    ...
    <div className="footer-inner">
      <div className="footer-top">
        <div style={{ display:"flex", alignItems:"center", gap:"9px" }}>
          <StockLogo size={20} gradientId="footer-gradient" />
        ...
        <div className="footer-links">
          {["Terms of Use", "Legal Notice", "Privacy Policy", "Contact"].map((link) => (
            <a
              key={link}
              href="#"
              style={{ color:"#2A3F60", fontSize:"14px", fontWeight:500, textDecoration:"none", transition:"color 0.2s" }}
      ...
      <div className="footer-copy">© 2026 STOCK — All rights reserved.</div>
    </div>
  </div>
)
